...
class LogDBFoodForm extends StatelessWidget {
  const LogDBFoodForm({Key? key, required this.externalId}) : super(key: key);

  final String externalId;

  @override
  Widget build(BuildContext context) {
    return BlocListener<LogDBFoodCubit, LogState>(
      ...
      child: Column(
        ...
        children: [
          ...
          _MealDateInput(),
          _LogButton(externalId: externalId),
...
class _MealTypeInput extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return BlocBuilder<LogDBFoodCubit, LogState>(
    ...
    return BlocBuilder<LogDBFoodCubit, LogState>(
      ...
      builder: (context, state) {
        return TextFormField(
          ...
          onChanged: (mealDate) =>
              context.read<LogDBFoodCubit>().mealDateChanged(mealDate),
...
class _LogButton extends StatelessWidget {
  const _LogButton({Key? key, required this.externalId}) : super(key: key);
        ...
        return state.status.isSubmissionInProgress
            ...
            : ElevatedButton(
                ...
                onPressed: state.status.isValidated
                    ? () {
                        context.read<LogDBFoodCubit>().logDBFood(
