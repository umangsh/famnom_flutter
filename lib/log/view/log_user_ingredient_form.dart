...
class LogUserIngredientForm extends StatelessWidget {
  const LogUserIngredientForm({
    Key? key,
  ...
  Widget build(BuildContext context) {
    return BlocListener<LogUserIngredientCubit, LogState>(
...
class _MealTypeInput extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return BlocBuilder<LogUserIngredientCubit, LogState>(
    ...
    return BlocBuilder<LogUserIngredientCubit, LogState>(
      ...
      builder: (context, state) {
        return TextFormField(
          ...
          onChanged: (mealDate) =>
              context.read<LogUserIngredientCubit>().mealDateChanged(mealDate),
